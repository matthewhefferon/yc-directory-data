...
export default function Filters({
  ...
  const clearFilters = () => {
    setFilters({ batch: "", status: "", industry: "", search: "" });
  };

  const hasActiveFilters =
    filters.batch || filters.status || filters.industry || filters.search;
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-3 pr-16 py-2 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yc-orange focus:border-transparent"
          />
        </div>
